...
const projects = [
  ...
  },
  {
    ...
    description: 'Complete travel and tourism booking platform with hotel, flight, restaurant, activity, cruise, and rental car management. Features admin dashboard, user authentication with 2FA, reservation system, forum, reviews, and notifications.',
    image: '/images/project4.jpg',
    tags: ['Laravel 12', 'Livewire', 'Tailwind CSS', 'Jetstream', 'Spatie Media'],
    category: 'fullstack',
  ...
  {
    id: 5,
    title: 'LaLibrary - Online Bookstore',
    description: 'Online bookstore with 21+ books across 13 categories, user registration and authentication, admin panel for book CRUD management, shopping cart, order tracking with status management, and responsive design.',
    image: '/images/project5.jpg',
    tags: ['PHP', 'MySQL', 'PDO', 'Bootstrap', 'JavaScript'],
    category: 'fullstack',
